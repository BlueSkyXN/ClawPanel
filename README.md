...
[![Lite](https://img.shields.io/badge/Lite-0.1.9-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.10` 继续收口发布链路与 Gitee 同步；`ClawPanel Lite v0.1.9` 在保持 Linux 稳定可用的同时继续推进 Windows / macOS 预览打包。详见 [changelogs/v5.2.10.md](changelogs/v5.2.10.md) 和 [changelogs/lite-v0.1.9.md](changelogs/lite-v0.1.9.md)
...
- 安装与更新默认优先走 GitHub Release，网络异常时自动回退到北京加速服务器
