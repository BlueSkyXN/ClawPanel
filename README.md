...
[快速开始](#-快速开始) · [功能特性](#-主要功能) · [更新日志](changelogs/) · [API 文档](docs/API.md) · [贡献指南](CONTRIBUTING.md) · [安全策略](SECURITY.md) · [English](README_EN.md)
...
> [!NOTE]
> **最新发布** — `ClawPanel Pro v5.3.0` 与 `ClawPanel Lite v0.2.0` 已发布；若一键安装/手动更新没有拿到最新版，请优先重新拉取安装脚本。

### 💬 社区交流
欢迎加入 **ClawPanel 官方交流群**，获取最新更新、反馈问题、参与插件开发。

- GitHub Discussions：<https://github.com/zhaoxinyi02/ClawPanel/discussions>
- Wiki：<https://github.com/zhaoxinyi02/ClawPanel/wiki>
