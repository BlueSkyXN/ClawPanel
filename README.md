...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.11` 前端懒加载提升首屏性能、修复 agent/channel 稳定性问题、安装脚本切换 Gitee 入口；`ClawPanel Lite v0.1.10` 修复 fresh Linux Lite 安装后 OpenClaw / 网关离线的问题；Windows Lite 因整包超 2GB 限制已停止提供，Windows 用户请使用 Pro 版。详见 [changelogs/v5.2.11.md](changelogs/v5.2.11.md) 和 [changelogs/lite-v0.1.10.md](changelogs/lite-v0.1.10.md)
