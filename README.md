...
[![Pro](https://img.shields.io/badge/Pro-5.2.10-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
[![Lite](https://img.shields.io/badge/Lite-0.1.10-2563eb?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.10` 继续收口发布链路，并支持 GitHub Release 后同步到香港加速服务器；`ClawPanel Lite v0.1.10` 修复 fresh Linux Lite 安装后 OpenClaw / 网关离线的问题，并继续推进 Windows / macOS 预览打包。详见 [changelogs/v5.2.10.md](changelogs/v5.2.10.md) 和 [changelogs/lite-v0.1.10.md](changelogs/lite-v0.1.10.md)
...
```powershell
iwr https://gitee.com/zxy000006/ClawPanel/raw/main/scripts/install-lite.ps1 -OutFile install-lite.ps1; powershell -ExecutionPolicy Bypass -File .\install-lite.ps1
```
...
```powershell
iwr https://gitee.com/zxy000006/ClawPanel/raw/main/scripts/uninstall-lite.ps1 -OutFile uninstall-lite.ps1; powershell -ExecutionPolicy Bypass -File .\uninstall-lite.ps1
```
**ClawPanel Pro（Linux）**
...
以下命令用于清理你系统里**单独安装**的 `openclaw`（例如 npm 全局安装、用户目录下的 `~/.openclaw` / `~/openclaw`），**不会删除** Lite 自己安装目录中的内嵌运行时：

- Lite Linux / macOS：`/opt/clawpanel-lite/runtime`
- Lite Windows：`C:\ClawPanelLite\runtime`
...
#### v0.1.10 — Linux Fresh Install 稳定性修复
...
<details>
<summary><b>更早 Lite 规划记录</b></summary>
