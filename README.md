...
[![Version](https://img.shields.io/badge/version-5.0.3-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **v5.0.3 新增** — 🧩 插件中心（插件市场 + 一键安装/卸载/配置/更新）、Windows NapCat 原生安装（无需 Docker）、跨平台安装脚本优化、反斜杠转义修复。

> [!WARNING]
> **macOS 用户注意** — 目前开发者暂时没有 macOS 设备，近期将购置一台 Mac 用于开发和测试。如果 macOS 上遇到 bug，请通过 [Issues](https://github.com/zhaoxinyi02/ClawPanel/issues) 反馈，我们会在拿到 Mac 后统一处理。感谢理解！
