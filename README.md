...
> [!NOTE]
> **最新 Pro / Lite 更新** — `ClawPanel Pro v5.2.10` 继续收口发布链路，并支持 GitHub Release 后同步到香港加速服务器；`ClawPanel Lite v0.1.10` 修复 fresh Linux Lite 安装后 OpenClaw / 网关离线的问题；Windows Lite 因整包超 2GB 限制已停止提供，Windows 用户请使用 Pro 版。详见 [changelogs/v5.2.10.md](changelogs/v5.2.10.md) 和 [changelogs/lite-v0.1.10.md](changelogs/lite-v0.1.10.md)
...
#### v0.1.10 — Linux Fresh Install 稳定性修复 + Windows Lite 停止提供
...
- **🪟 停止提供 Windows Lite**：Windows 整包超过 GitHub Release 2GB 上传限制，Windows 用户请使用 Pro 版
