...
[![Version](https://img.shields.io/badge/version-5.0.8-violet?style=flat-square)](https://github.com/zhaoxinyi02/ClawPanel/releases)
...
> [!NOTE]
> **v5.0.4 新增** — 🔧 NapCat 一键诊断修复、系统诊断报告、扫码登录自动检测+关闭弹窗、禁用自动登录、安装后自动重启容器、PATH 检测修复。
